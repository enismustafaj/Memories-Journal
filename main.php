...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            <h2 style="font-family: Apple Chancery, cursive"> My Traveling Book</h2>
        </div>
    ...
    <div class="row">
            ...
            <div class="container">
                ...
                <div class="panel-group col-sm-3" id="accordion">
                    ...
                    <div class="col">
                        ...
                        <div class="col">
                                    <a href="http://localhost/upload.php"><button class="btn btn-info" style="width:250px; background-color:green">
            <span class=""></span> Photos
                        </div>
        ...
        <div style="height:550px; width:100%;">
            ...
            <p><a href="main.php?logout='1'" style="color: red;"><button class="btn btn-danger"> logout</button> </a></p>
        <?php endif ?>
